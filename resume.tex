...
\begin{education}
    ...
    \begin{entryleft}{Cornell University}{College of Arts and
        Sciences}{Aug 2018 -- May 2022 (Expected)}
    ...
    % \end{rightcolumn}
        ...
        \begin{description}
            \item Bachelor of Arts in Computer Science --- 4.0 GPA
    ...
    \begin{entry}{Software Co-Lead}{Cornell University Autonomous Underwater
        ...
        \begin{description}
            \item Created robust vision modules for the underwater vehicle to
                identify mission elements that adapts to different lighting
                conditions by combining computer vision techniques including
                thresholding, SIFT, and Hu Moments
            ...
            \item Lead a team of 10 people in software meetings twice a week to
                assess and follow-up on team progress
...
% \begin{skills}
    \begin{smalldescription}
        \item \textbf{Programming Languages:} Python, Java, Rust, C\#, OCaml,
            C/C++, php, hack
