...
\begin{experience}
    \begin{entry}{Software Engineer Intern}{Facebook}{Jun 2020 --- Aug 2020}
        \begin{description}
            \item Worked on chaos testing tool using python and injected
                failures into core infrastructure and unix systems to test the
                reliability of services
            \item Improved error handling for tool to better identify reasons
                for test failure, logging them to a MYSQL database to be queried
                by the end user
            \item Made a web user interface for users to view or query test
                failure logs
            \item Created an cron job that detects broken or consistently
